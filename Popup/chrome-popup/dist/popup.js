console.log("popup.js is running in public!");

const intervalID = setInterval(() => {
  if(document.getElementById("speedSlider") != null){

    //document.addEventListener("DOMContentLoaded", () => {
      console.log("Looking for #speedSlider");
      console.log("Found #speedSlider →", speedSlider);
      ...
      chrome.storage.sync.get(["playbackSpeed", "maxSpeed", "sliderStep", "speedUpAds"], (data) => {
        ...
        if (adSpeedupCheckbox.checked){
          adSpeedupCheckbox.click();
        }
      });
